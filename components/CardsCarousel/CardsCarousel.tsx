...
export function CardsCarousel() {
  ...
  const autoplay = Autoplay({ delay: 10000 }); // Autoplay with 10-second interval

  // Mapping data to Carousel slides
  ...
  return (
    <Group align="center" justify="center" mt={50} gap={50}>
      <Title ta="center">Darba Procesa Attēli</Title>
